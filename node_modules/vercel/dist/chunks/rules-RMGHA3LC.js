...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-DL6Y2ECG.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-DL6Y2ECG.js")).default(client, args);
    case "add":
      return (await import("./add-LTKUOIRH.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-ZC2GT4MO.js")).default(client, args);
    case "rm":
      return (await import("./rm-A4HRBNZ5.js")).default(client, args);
    case "update":
      return (await import("./update-IIPJIUMA.js")).default(client, args);
    default:
